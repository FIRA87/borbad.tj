                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group mb-3">
                                                ...
                                                <input type="text" id="title_tj"
                                                    class="form-control @error('title_tj') is-invalid @enderror"
                                                    name="title_tj" value="{{ old('title_tj') }}">
                                                @error('title_tj')
                                                    <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="form-group mb-3 col-md-4">
                                            <div class="form-group mb-3">
                                                ...
                                                <input type="datetime-local" id="publish_date" class="form-control"
                                                    name="publish_date"
                                        ...
                                        <div class="col-md-4 mt-3">
                                            <div class="form-group mb-3">
                                                ...
                                                <input type="file" class="form-control" name="gallery[]"
                                                    id="gallery" multiple accept="image/*">
                                                ...
                                                <div class="col-md-1">
                                                    <div class="form-check mb-2 form-check-primary">
                                                        <input class="form-check-input" type="checkbox" name="top_slider"
                                                            ...
                                                            {{ old('top_slider') ? 'checked' : '' }}>
                                                        <label class="form-check-label"
                                                            for="customckeck_2">Слайдер</label>
                                                    </div>
                                                </div>
