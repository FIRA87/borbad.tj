                        ...
                        <div class="collapse" id="page">
                            <ul class="nav-second-level">
                                @if (Auth::user()->can('menu.list'))
                                    <li> <a href="{{ route('all.pages') }}"> <i class="mdi mdi-animation"></i> Все</a>
                                    </li>
                                @endif

                                @if (Auth::user()->can('menu.add'))
                                    <li> <a href="{{ route('add.pages') }}"> <i
                        ...
                        <div class="collapse" id="sidebarEcommerce">
                            <ul class="nav-second-level">
                                ...
                                @if (Auth::user()->can('category.add'))
                                    <li style="margin-left: -20px">
                                        <a href="{{ route('add.category') }}"><i class="mdi mdi-database-plus"></i>
                                            Добавить </a>
                                    </li>
                                @endif
...
@endif 
                ...
                {{-- Страница «О нас» — редактирование контента в админке --}}
                <li>
                    <a href="{{ route('admin.about.index') }}">
                        <i class="mdi mdi-information-outline"></i>
                        <span> О нас (редактировать) </span>
                    </a>
                </li>
                        ...
                        <div class="collapse" id="sidebarCrm">
                            <ul class="nav-second-level">
                                ...
                                @if (Auth::user()->can('video.add'))
                                    <li style="margin-left: -20px">
                                        <a href="{{ route('add.video') }}"><i class="mdi mdi-database-plus"></i>
                                            Добавить </a>
                                    </li>
                                @endif
                    ...
                    <li>
                        ...
                        <div class="collapse" id="sidebarServices">
                            <ul class="nav-second-level">
                                ...
                                @if (Auth::user()->can('services.menu'))
                                    <li style="margin-left: -20px">
                                        <a href="{{ route('all.service.requests') }}"><i
                                                class="mdi mdi-animation"></i> Заявки на услуги </a>
                                    </li>
                                @endif
                    ...
                    <li>
                        ...
                        <div class="collapse" id="sidebarJob">
                            <ul class="nav-second-level">
                                @if (Auth::user()->can('jobs.menu'))
                                    <li style="margin-left: -20px">
                                        <a href="{{ route('admin.jobs.index') }}"><i class="mdi mdi-animation"></i>
                                            Все </a>
                                    </li>
                                @endif
                                @if (Auth::user()->can('jobs.menu'))
                                    <li style="margin-left: -20px">
                                        <a href="{{ route('backend.applications.index') }}"><i
                                                class="mdi mdi-animation"></i> Заявки на вакансии</a>
                                    </li>
                                @endif
                        ...
                        <div class="collapse" id="sidebarDocument">
                            <ul class="nav-second-level">
                                @if (Auth::user()->can('documents.list'))
                                    <li style="margin-left: -20px">
                                        <a href="{{ route('documents.index') }}"><i class="mdi mdi-animation"></i>
                                            Все
                                        </a>
                                    </li>
                                @endif
                        ...
                        <div class="collapse" id="sidebarEmail">
                            <ul class="nav-second-level">
                                ...
                                @if (Auth::user()->can('admin.add'))
                                    <li style="margin-left: -20px">
                                        <a href="{{ route('add.admin') }}"><i class="mdi mdi-database-plus"></i>
                                            Добавить
                                        </a>
                                    </li>
                                @endif
